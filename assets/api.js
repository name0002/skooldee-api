...
(function () {
  ...
  window.API = {
    ...
    richMenu:        function ()     { return req('/api/rich-menu'); },
    publishRichMenu: function (d)    { return req('/api/rich-menu/publish',          { method: 'POST',   body: JSON.stringify(d) }); },
    deleteRichMenu:  function ()     { return req('/api/rich-menu',                  { method: 'DELETE' }); },
